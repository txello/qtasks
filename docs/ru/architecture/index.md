...
Эти детали вынесены за пределы ядра и подключаются через реализации абстрактных интерфейсов.
...
состоит из компонентов, связанных контрактами — абстрактными классами и схемами данных.
